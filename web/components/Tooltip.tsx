...
export default function Tooltip({ text, children }: TooltipProps) {
  ...
  return (
    <div className="relative inline-block" ref={tooltipRef}>
      ...
      {isVisible && (
        <div className="absolute z-50 px-5 py-4 text-sm text-white rounded-xl max-w-lg whitespace-normal pointer-events-none" style={{ background: 'linear-gradient(135deg, rgba(15, 23, 42, 0.95) 0%, rgba(30, 41, 59, 0.95) 100%)', top: '100%', left: '50%', transform: 'translateX(-50%)', marginTop: '12px', border: '2px solid rgba(0, 217, 255, 0.6)', lineHeight: '1.6', overflow: 'visible', boxShadow: '0 15px 50px rgba(0, 217, 255, 0.25), 0 0 30px rgba(0, 217, 255, 0.2), inset 0 1px 0 rgba(0, 217, 255, 0.1)' }}>
          {text}
