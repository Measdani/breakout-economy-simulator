      ...
      <div>
        ...
        <div className="space-y-6">
          ...
          <SliderSection
            ...
            tooltipText="A fractional tax applied to standardized compute units (SCUs) generated by AI systems. This captures value from machine productivity that bypasses traditional labor taxation."
          />
...
{/* Breakout Point - Incentive Structure */}
      ...
      />
      <SliderSection
        title="Workforce Incentive"
        subtitle="SBI Maximum"
        icon="SBI"
        color="blue"
        value={sbiMaximum}
